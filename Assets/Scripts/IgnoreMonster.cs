...
public class IgnoreMonster : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // Don't hide the renderer if the ending sequence already owns this object.
        if (monsterRenderer != null && !BunkerEndingSequence.IsActive)
        {
    ...
    void Update()
    {
        ...
        // Suspend all IgnoreMonster behaviour during the ending sequence.
        if (BunkerEndingSequence.IsActive) return;
